...
public class ViewPagerFragFast extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_view_pager_fast, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        fast_recyclerview = view.findViewById(R.id.fast_recyclerview);
        ...
        DividerItemDecoration dividerItemDecoration =
                new DividerItemDecoration(fast_recyclerview.getContext(),new LinearLayoutManager(getContext()).getOrientation());
        fast_recyclerview.addItemDecoration(dividerItemDecoration);
